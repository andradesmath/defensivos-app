...
import { Package, Layers, ChevronLeft, Tractor, AlertTriangle, ArrowLeft, LogOut } from "lucide-react";
...
export default function Estoque({ sessao, onSelectCategoria, onVoltar }) {
